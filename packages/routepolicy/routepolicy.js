(function () {
  ...
  Meteor.__RoutePolicy = function () {
    var self = this;
    self.urlPrefixTypes = {};
  };

  _.extend(Meteor.__RoutePolicy.prototype, {
    ...
    checkType: function (type) {
      if (! _.contains(['app', 'network'], type))
        return 'the route type must be "app" or "network"';
      return null;
    },
    ...
    checkForConflictWithStatic: function (urlPrefix, _testManifest) {
      var self = this;
      ...
      if (conflict)
        return 'static resource ' + conflict.url + ' conflicts with url prefix ' + urlPrefix;
      else
        return null;
    },
    ...
    declare: function (urlPrefix, type) {
      ...
      var problem = self.checkType(type) ||
                    ...
                    self.checkForConflictWithStatic(urlPrefix);
      if (problem)
  ...
  Meteor._routePolicy = new Meteor.__RoutePolicy();
})();
